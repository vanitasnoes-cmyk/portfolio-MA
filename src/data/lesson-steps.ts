...
export const LESSON_STEPS: LessonStep[][] = [
  ...
  [
    ...
    { text: '2. Xác định phạm vi tìm kiếm thông tin: Giới hạn thời gian từ năm 2018 đến 2026. Tìm kiếm các bài báo khoa học, báo cáo công nghệ và sách chuyên khảo trên Google Scholar, PubMed, Cochrane Library với các từ khóa CNN, GAN, hiện tượng "Hộp đen", rủi ro dữ liệu sai lệch. chi tiết xem ở bản báo cáo.' },
    { text: '3. Tìm kiếm tài liệu chuyên ngành: Thu thập 10 nguồn tài liệu y sinh uy tín từ Diagnostics, Radiologia, Bioengineering, British Journal of Radiology, thông tin phê duyệt của FDA đối với phần mềm MIM Contour ProtégéAI của GE HealthCare, và Báo Tuổi Trẻ. chi tiết xem ở bản báo cáo.' },
    { text: '4. Đánh giá độ tin cậy của nguồn thông tin: Thẩm định 10 nguồn thông tin dựa trên 5 tiêu chí: Uy tín tác giả, Cơ quan/Tạp chí xuất bản, Phương pháp nghiên cứu, Số lượng trích dẫn học thuật và Tính cập nhật của tài liệu. chi tiết xem ở bản báo cáo.' },
    { text: '5. Kết luận & Tổng hợp lâm sàng: Qua bài tôi đã biết cách tìm tài liệu ở các nguồn uy tín đồng thời đánh giá độ uy tín của nguồn. chi tiết xem ở bản báo cáo.' }
  ],
  ...
  [
    ...
    { text: '2. Thiết kế các phiên bản prompt: Xây dựng 3 cấp độ prompt cho từng tác vụ: Cơ bản (Zero-shot, lệnh ngắn), Cải tiến (thêm ngữ cảnh, đối tượng sinh viên), và Nâng cao (áp dụng kỹ thuật đóng vai giáo sư, Few-shot Examples và Chain-of-Thought). chi tiết xem ở bản báo cáo.' },
    ...
    { text: '5. Tổng hợp nguyên tắc viết prompt tối ưu: Đúc kết 4 nguyên tắc vàng trong thiết kế prompt y học: Gán vai trò (Persona), Bối cảnh & Mục tiêu (Context), Phân tầng nhiệm vụ (Task Decomposition), và Các ràng buộc/định dạng đầu ra cụ thể. chi tiết xem ở bản báo cáo.' }
  ],
  ...
  [
    ...
    { text: '5. Giao tiếp và hỗ trợ mọi người trog quá trình làm: Sau đây là minh chứng cho phần trên.' },
    { text: '6. các thách thức có thể xảy ra trong quá trình làm việc: Thách thức 1: Bất đồng bộ thời gian và "trôi tin nhắn" Vấn đề: Lịch học sinh viên Y1 lệch nhau, thảo luận qua chat bị trôi thông tin quan trọng. Thành viên online muộn ngại đọc lại, dẫn đến nắm sai dữ liệu và mất kết nối. Giải pháp: Chuyển sang quản lý tập trung qua Google Docs và Trello. Mọi kịch bản, phân công được lưu cố định và cập nhật rõ ràng; giảm 80% thời gian chat vô định hình. Thách thức 2: Gửi file lộn xộn, giảm chất lượng và lạc mất tài nguyên Vấn đề: Thành viên gửi video thô trực tiếp vào group chat khiến file bị nén (mờ, vỡ nét), không đủ chất lượng edit TikTok. File không được đặt tên, nằm rải rác gây mất thời gian tìm kiếm và dễ sót. Giải pháp: Quy hoạch toàn bộ tài nguyên lên Google Drive. Yêu cầu nộp file vào thư mục phân loại sẵn và đặt tên thống nhất để đảm bảo chất lượng gốc và tối ưu tốc độ dựng video.' }
  ],
  ...
  [
    ...
    { text: '5. Đánh giá vai trò của AI tạo sinh: Nhận định AI là trợ lý đắc lực giúp giải phóng sức lao động, nâng cao hiệu suất thiết kế video truyền thông và giải quyết triệt để vấn đề bản quyền hình ảnh y khoa. chi tiết xem ở bản báo cáo.' },
  ...
  [
    { text: '1. Nghiên cứu chính sách AI của VinUniversity: Tìm hiểu Guidelines của VinUni về việc sử dụng AI, phân tích sâu Thang đánh giá mức độ sử dụng AI (AIAS) trong học tập và thi cử. chi tiết xem ở bản báo cáo.' },
    ...
    { text: '4. Đúc kết bộ 6 nguyên tắc cá nhân sử dụng AI: chi tiết xem ở bản báo cáo.' },
  ...
  [
    ...
    { text: '3. Phân tích vai trò AI trong lâm sàng: AI đóng vai trò là trợ lý thu thập chỉ số tự động, đưa ra cảnh báo sớm nguy cơ đột quỵ từ dữ liệu lịch sử và gợi ý phác đồ lâm sàng chuẩn y khoa cho bác sĩ. chi tiết xem ở bản báo cáo.' },
    { text: '4. Đánh giá thách thức vùng cao & Giải pháp: Phân tích rào cản địa lý và hạ tầng internet (giải pháp đồng bộ offline) cùng khó khăn của người cao tuổi khi dùng app (giải pháp trợ lý giọng nói tiếng Việt và sự hỗ trợ trực tiếp của y tá xã). chi tiết xem ở bản báo cáo.' }
  ]
];
