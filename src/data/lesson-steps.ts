...
export const LESSON_STEPS: LessonStep[][] = [
  ...
  [
    ...
    { text: '6. Các thách thức có thể xảy ra trong quá trình làm việc: Thách thức 1: Bất đồng bộ thời gian và "trôi tin nhắn"\n\nVấn đề: Lịch học sinh viên Y1 lệch nhau, thảo luận qua chat bị trôi thông tin quan trọng. Thành viên online muộn ngại đọc lại, dẫn đến nắm sai dữ liệu và mất kết nối.\n\nGiải pháp: Chuyển sang quản lý tập trung qua Google Docs và Trello. Mọi kịch bản, phân công được lưu cố định và cập nhật rõ ràng; giảm 80% thời gian chat vô định hình.\n\nThách thức 2: Gửi file lộn xộn, giảm chất lượng và lạc mất tài nguyên\n\nVấn đề: Thành viên gửi video thô trực tiếp vào group chat khiến file bị nén (mờ, vỡ nét), không đủ chất lượng edit TikTok. File không được đặt tên, nằm rải rác gây mất thời gian tìm kiếm và dễ sót.\n\nGiải pháp: Quy hoạch toàn bộ tài nguyên lên Google Drive. Yêu cầu nộp file vào thư mục phân loại sẵn và đặt tên thống nhất để đảm bảo chất lượng gốc và tối ưu tốc độ dựng video.' }
  ],
